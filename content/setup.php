<?php
/**
 * Demo site setup for Favorit Måleri AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Favorit Måleri AB' );
...
$home = nps_page(
	...
	nps_pattern( 'favoritmaleri/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'favoritmaleri/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'favoritmaleri/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'favoritmaleri/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'favoritmaleri/thank-you' ),
...
<p class="has-large-font-size">Favorit Måleri AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Favorit Måleri AB', $about_content . "\n\n" . nps_pattern( 'favoritmaleri/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'favoritmaleri/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Favorit Måleri AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Favorit Måleri AB demo ready.' );
