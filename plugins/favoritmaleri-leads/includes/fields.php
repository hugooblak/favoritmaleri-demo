...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'favoritmaleri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'favoritmaleri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'favoritmaleri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'favoritmaleri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'favoritmaleri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'favoritmaleri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'favoritmaleri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'favoritmaleri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'favoritmaleri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'favoritmaleri-leads' ),
		'contacted' => __( 'Kontaktad', 'favoritmaleri-leads' ),
		'quoted'    => __( 'Quote sent', 'favoritmaleri-leads' ),
		'won'       => __( 'Won', 'favoritmaleri-leads' ),
		'lost'      => __( 'Lost', 'favoritmaleri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'favoritmaleri-leads' ),
	);
}
